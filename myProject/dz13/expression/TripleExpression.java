...
public interface TripleExpression extends ToMiniString {
    ...
    static ExpressionTester<?, ?> tester(final TestCounter counter) {
        ...
        return new ExpressionTester<>(
                ...
                .basic("(x / -2)", "x / -2", (x, y, z) -> -x / 2, new expression.Divide(vx, c(-2)))
                ...
                .basic("(1 * (2 * 3))", "1 * 2 * 3", (x, y, z) -> 6, new Multiply(c(1), new Multiply(c(2), c(3))))
                .basic("((10 / 2) / 3)", "10 / 2 / 3", (x, y, z) -> 10 / 2 / 3, new expression.Divide(new expression.Divide(c(10), c(2)), c(3)))
                .basic("(10 / (3 / 2))", "10 / (3 / 2)", (x, y, z) -> 10, new expression.Divide(c(10), new expression.Divide(c(3), c(2))))
                .basic("((x * y) + ((z - 1) / 10))", "x * y + (z - 1) / 10", (x, y, z) -> x * y + (z - 1) / 10, new Add(
                        new Multiply(vx, vy),
                        new expression.Divide(new Subtract(vz, c(1)), c(10))
                ))
                ...
                .advanced("(2 / x)", "2 / x", (x, y, z) -> 2 / x, new expression.Divide(c(2), vx))
                ...
                .advanced("(z * (2 / x))", "z * (2 / x)", (x, y, z) -> z * (2 / x), new Multiply(vz, new expression.Divide(c(2), vx)))
                .advanced("(z / (y - x))", "z / (y - x)", (x, y, z) -> z / (y - x), new expression.Divide(vz, new Subtract(vy, vx)))
                ...
                .advanced("((2 / x) * y)", "2 / x * y", (x, y, z) -> 2 / x * y, new Multiply(new expression.Divide(c(2), vx), vy))
                .advanced("((1 + 1) / x)", "(1 + 1) / x", (x, y, z) -> (1 + 1) / x, new expression.Divide(new Add(c(1), c(1)), vx))
                ...
                .advanced("(1 + (2 / 3))", "1 + 2 / 3", (x, y, z) -> 1, new Add(c(1), new expression.Divide(c(2), c(3))))
                .advanced("(1 - (2 / 3))", "1 - 2 / 3", (x, y, z) -> 1, new Subtract(c(1), new expression.Divide(c(2), c(3))))
                ...
                .advanced("(1 - ((2 * x) + y))", "1 - (2 * x + y)", (x, y, z) -> 1 - (2 * x + y), new Subtract(c(1), new Add(new Multiply(
                        c(2), vx), vy)))
                .advanced("(1 * (z / (y - x)))", "1 * (z / (y - x))", (x, y, z) -> 1 * (z / (y - x)), new Multiply(c(1), new expression.Divide(vz, new Subtract(vy, vx))))
                .advanced("(z / (z + (1 + 1)))", "z / (z + 1 + 1)", (x, y, z) -> z / (z + 1 + 1), new expression.Divide(vz, new Add(vz, new Add(
                        c(1),
                        c(1)
                ))))
                ...
                .advanced("((y - x) * (2 / x))", "(y - x) * (2 / x)", (x, y, z) -> (y - x) * (2 / x), new Multiply(new Subtract(vy, vx), new expression.Divide(
                        c(2), vx)))
                .advanced("((y - x) / (2 * x))", "(y - x) / (2 * x)", (x, y, z) -> (y - x) / (2 * x), new expression.Divide(new Subtract(vy, vx), new Multiply(
                        c(2), vx)))
                ...
                .advanced("(((2 * x) + y) - z)", "2 * x + y - z", (x, y, z) -> 2 * x + y - z, new Subtract(new Add(new Multiply(
                        c(2), vx), vy), vz))
                .advanced("(((1 + 1) / x) * 2)", "(1 + 1) / x * 2", (x, y, z) -> (1 + 1) / x * 2, new Multiply(new expression.Divide(new Add(
                        c(1),
                        c(1)
                ), vx), c(2)))
                .advanced("((z / (y - x)) / x)", "z / (y - x) / x", (x, y, z) -> z / (y - x) / x, new expression.Divide(new Divide(vz, new Subtract(vy, vx)), vx));
    }
}
